    ...
    <>
      ...
      <article className="mx-auto max-w-6xl px-4 py-12 sm:py-16">
        ...
        <div className="mt-12 lg:flex lg:items-end lg:justify-between lg:gap-12">
          ...
          <Link
            href="/order/new"
            className="mt-8 inline-flex h-14 shrink-0 items-center justify-center rounded-lg bg-leaf-800 px-8 text-[17px] font-semibold text-white shadow-lift transition hover:bg-leaf-900 lg:mt-0"
          >
