...
export const metadata: Metadata = {
  ...
  description:
    "Pre-order a complete lulav and etrog set from Eretz Yisrael: esrog, lulav, hadassim and aravos, sorted by Morei Hora'ah and sealed. Three levels from $45, collected in Airmont, NY in time for Yom Tov.",
  openGraph: {
    title: "Lulav and Etrog Sets, Rav-Inspected | V'samachta Arba Minim",
    description:
      "Complete Arba Minim sets from $45, sorted by a Rav in Eretz Yisrael and sealed, collected in Airmont, NY before Yom Tov.",
    type: "website",
